 ...
 * 科目余额实体
 */
public class SubjBalance implements Balance {
    ...
    private BigDecimal initDebitQuant;  // 期初借方余额(数量)
    private BigDecimal initDebitAmount; // 期初借方余额(原币)
    private BigDecimal initDebitAuxAmount;  // 期初借方余额(累计)
    private BigDecimal initDebitLocAmount;  // 期初借方余额(本币)
    private BigDecimal initCreditQuant;     // 期初贷方余额(数量)
    private BigDecimal initCreditAmount;    // 期初贷方余额(原币)
    private BigDecimal initCreditAuxAmount; // 期初贷方余额(累计)
    ...
    private String pk_accsubj_name;         // 科目名称
